...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO CUSTOMER (Name, Phone, Email, Address, City) 
        ...
        <div class="result-card">
            ...
            <div class="result-body">
                ...
                <p style="color: #64748b; margin-top: 1.5rem; text-align: center;">
                    ...
                    The customer record has been saved to the database
                </p>

                <div class="action-buttons">
                    <a href="customer_form.php" class="btn btn-primary-enhanced btn-enhanced">
