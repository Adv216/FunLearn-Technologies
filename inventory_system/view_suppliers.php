...
$sql = "SELECT Supplier_ID, Name, Phone, Email FROM SUPPLIER ORDER BY Name ASC";
    ...
    <div class="container-main">
        ...
        <div class="action-bar">
            ...
            <div style="color: #64748b; font-weight: 500;">
                ...
                Total: <strong style="color: #1e293b;"><?= $result->num_rows ?></strong> suppliers
            </div>
        </div>
        ...
        <?php if ($result->num_rows > 0): ?>
            <div class="table-card">
                ...
                <div class="table-responsive">
                    <table class="table table-modern" id="supplierTable">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Supplier Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><span class="supplier-id">#<?= htmlspecialchars($row['Supplier_ID']) ?></span></td>
                                <td>
        ...
        <?php else: ?>
            <div class="table-card">
                <div class="empty-state">
                    ...
                    <a href="supplier_form.php" class="btn btn-warning-enhanced btn-enhanced mt-3">
                        <i class="fas fa-truck-loading me-2"></i>Add First Supplier
                    </a>
                </div>
            </div>
        <?php endif; ?>
